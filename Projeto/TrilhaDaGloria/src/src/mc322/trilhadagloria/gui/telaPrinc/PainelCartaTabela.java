...
public class PainelCartaTabela extends JPanel implements ListSelectionListener {
    ...
    public PainelCartaEst() {
        ...
        setOpaque(true);
        setLayout(null);
        cardInfos = new String[3];
    }
    
    public void conectarTab(TabelaCartas tab) {
    	this.tab = tab;
    }
    
    protected void atualizarCardInfos(String infoTipo, 
    									String infoNome, String infoDom) {
    	cardInfos[0] = infoTipo;
    	cardInfos[1] = infoNome;
    	cardInfos[2] = infoDom;
    }

    public void valueChanged(ListSelectionEvent ev) {
        int idx = ev.getFirstIndex();
        atualizarCardInfos(tab.getValueAt(idx, 0), 
        					tab.getValueAt(idx, 1), tab.getValueAt(idx, 2));
        gerarCarta();
    }
